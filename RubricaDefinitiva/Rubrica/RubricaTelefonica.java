/**
 * La classe implementa un'applicazione basata sulla rubrica telefonica
 * consente all'utente di aggiungere, modificare, cercare, rimuovere e visualizzare
 * i contatti.
 */
package Rubrica;
...
public class RubricaTelefonica {
    ...
    // Crea un file stringa che contiene il percorso del file di salvataggio
    private static final String NOME_FILE = "rubrica.dat";

    /**
     * Metodo principale del programma.
     * Si occupa del menu e dell'interazione con l'utente.
     */
    ...
    /**
     * Modifica un contatto se esistente nella rubrica.
     */
    ...
    /**
     * Cerca un contatto nella rubrica con nome e cognome.
     */
    ...
    /**
     * Carica i contatti dal file di salvataggio al momento dell'avvio del programma.
     */
    ...
    /**
     * Salva i contatti nel file di salvataggio prima di uscire dal programma.
     */
